...
class Team < ApplicationRecord
  has_many :home_matches, class_name: 'Match', foreign_key: 'team_home_id', dependent: :restrict_with_exception # rubocop:disable Rails/InverseOf
  has_many :away_matches, class_name: 'Match', foreign_key: 'team_away_id', dependent: :restrict_with_exception # rubocop:disable Rails/InverseOf
